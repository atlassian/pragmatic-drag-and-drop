...
- Distance dampening is applied when in the "cross axis" component of an edges hitbox. This is so
  that the scroll speed matches on the cross axis plane when moving in and out of an element. This
  sounds confusing, but it feels great!

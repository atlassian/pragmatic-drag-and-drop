...
export type TextSelectionEventBasePayload =
  BaseEventPayload<TextSelectionDragType>;
...
export type TextSelectionMonitorGetFeedbackArgs =
  MonitorGetFeedbackArgs<TextSelectionDragType>;

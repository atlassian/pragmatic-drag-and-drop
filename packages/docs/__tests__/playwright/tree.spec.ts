...
test.describe('tree', () => {
  test('should allow a tree item to be reordered above another item', async ({
    page,
  }) => {
  ...
  test('should allow a tree item to be reordered below another item', async ({
    page,
  }) => {
    await page.visitExample('pragmatic-drag-and-drop', 'docs', 'tree');
    await page.waitForSelector('[draggable="true"]');
  ...
  test('should allow a tree item to become a child of another tree item', async ({
    page,
  }) => {
    await page.visitExample('pragmatic-drag-and-drop', 'docs', 'tree');
    await page.waitForSelector('[draggable="true"]');
  ...
  test('should allow a tree item to be reparented from level 2 -> level 1', async ({
    page,
  }) => {
    await page.visitExample('pragmatic-drag-and-drop', 'docs', 'tree');
    await page.waitForSelector('[draggable="true"]');
  ...
  test('should allow a tree item to be reparented from level 2 -> level 0', async ({
    page,
  }) => {
    await page.visitExample('pragmatic-drag-and-drop', 'docs', 'tree');
    await page.waitForSelector('[draggable="true"]');

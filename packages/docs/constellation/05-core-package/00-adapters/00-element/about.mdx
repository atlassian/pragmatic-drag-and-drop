...
- `getInitialData?: (args: GetFeedbackArgs) => Record<string, unknown>`: a one time attaching of data to a draggable as a drag is starting. If you want to understand the _type_ of data attached to a drop target elsewhere in your application, see our [typing data guide](../../recipes/typing-data).

...
We plan on creating a package for easy consumption of our `DragEvent` polyfill, but in the meantime, you can copy it from [Github](https://gist.github.com/alexreardon/cbc317ede2212d6db59ba5ff59dcf419)

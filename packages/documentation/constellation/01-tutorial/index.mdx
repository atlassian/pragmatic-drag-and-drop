...
[draggables](/components/pragmatic-drag-and-drop/core-package/adapters/elements),
[drop targets](./core-package/drop-targets) and
...
[this page](/components/pragmatic-drag-and-drop/adapters/element-adapter).
...
See [this page](/components/pragmatic-drag-and-drop/drop-targets), for the full documentation on
drop targets.
...
See [our monitor page](/components/pragmatic-drag-and-drop/monitors), for the full documentation on
monitors.
...
[our external adapter page](/components/pragmatic-drag-and-drop/adapters/external) .

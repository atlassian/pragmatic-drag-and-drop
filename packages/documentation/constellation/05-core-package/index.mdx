...
- [The element adapter](/components/pragmatic-drag-and-drop/adapters/element): `/element/adapter`
  (`@atlaskit/pragmatic-drag-and-drop/element/adapter`)
- [An array reordering utility](/components/pragmatic-drag-and-drop/utilities): `/reorder`
...
1. A way of registering [drop target](/components/pragmatic-drag-and-drop/drop-targets) (eg
   `dropTargetForElements`).
2. A way to create a [monitor](/components/pragmatic-drag-and-drop/monitor) (eg
   `monitorForExternal`).
...
- Head to our [adapter documentation](/components/pragmatic-drag-and-drop/adapters) to start
  installing the pieces you need
- Learn more about our [design](/components/pragmatic-drag-and-drop/design-guidelines) and
  [accessibility](./accessibility-guidelines) guidelines.

...
Please also see our [accessibility guide](/components/pragmatic-drag-and-drop/accessibility-guide)
which talks about our guidance for placing an action menu trigger on draggable entities.
...
[accessibility guide](/components/pragmatic-drag-and-drop/accessibility-guide)). In those cases,
please use our
[drag handle icon button](/components/pragmatic-drag-and-drop/optional-packages/react-accessibility).
...
Implement with
[native drag previews](/components/pragmatic-drag-and-drop/adapters/element/drag-previews), or use
the
...
- [Accessibility guide](/components/pragmatic-drag-and-drop/accessibility-guidelines)

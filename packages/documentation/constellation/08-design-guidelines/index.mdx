...
[Pragmatic drag drop Figma UI Kit (Atlassians only)](https://go.atlassian.com/pdnd-01)
(Atlassian only).
...
in code or the
[Figma kit drag handle menu (Atlassian only)](https://go.atlassian.com/pdnd-01)
in designs.

...
jest.mock(
  '../../../src/internal/get-scroll/get-scroll-on-axis/dampen-value-by-time',
  () => ({
...
jest.mock(
  '../../../src/internal/get-scroll/get-scroll-on-axis/get-value-from-distance',
  () => ({
...
describe('getValue()', () => {
  ...
  it('should return scroll value when shouldUseTimeDampening is false', () => {
    ...
    expect(getScrollValue({ shouldUseTimeDampening: false })).toEqual(
      scrollValue,
    );
  });
});

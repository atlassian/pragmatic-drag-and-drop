...
description: An optional package that enables automatic scrolling during a drag operation. This package is a port of the react-beautiful-dnd auto scroller
---
...
This package is a port of the auto scroller from [`react-beautiful-dnd`](https://github.com/atlassian/react-beautiful-dnd). Please now use our [new auto scroller](../auto-scroll).
